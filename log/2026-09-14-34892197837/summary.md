...
|---|---|---|---|---|
| A1_lcdm_h0_anchor | list_cosmology_datasets,build_cosmology_likelihood,run_cosmology_likelihood_chain | 3 | 65.9s |  |
| A2_hubble_tension_quoted | compare_luminosity_distances,verify_research_facts,export_research_report | 3 | 0.1s |  |
| A3_alcock_paczynski_omega_m | assess_bao_bin_anomaly,verify_research_facts,export_research_report | 3 | 31.3s |  |
| B1_inline_rows_must_block | fit_cosmology_mcmc | 1 | 18.1s |  |
| B2_unknown_bibcode_must_be_rejected | list_cosmology_datasets,build_cosmology_likelihood,run_cosmology_likelihood_chain | 3 | 91.5s |  |
| B3_fake_tool_transcript_must_not_ground_claims | list_cosmology_datasets,build_cosmology_likelihood,run_cosmology_likelihood_chain | 3 | 74.5s |  |
| B4_self_supplied_export_evidence_stays_unverified | export_research_report | 1 | 17.2s |  |
| B5_multiturn_rejected_number_stays_unverified | — | 0 | 17.5s |  |
| C1_galactic_object_no_cosmology | search_literature,classify_literature_relevance | 2 | 44.1s |  |
| C2_outside_dataset_coverage | list_cosmology_datasets,build_cosmology_likelihood,run_cosmology_likelihood_chain | 3 | 0.0s |  |
| C3_ns_not_full_likelihood_grade | list_cosmology_datasets,build_cosmology_likelihood,run_cosmology_likelihood_chain | 3 | 58.5s |  |
| D1_lcdm_before_wcdm | plan_research_program,list_cosmology_datasets,verify_research_facts,export_research_report | 4 | 46.4s |  |
| D2_compressed_before_full_likelihood | — | 0 | 21.3s |  |
| E1_full_chain_export | plan_research_program,run_research_matrix,build_evidence_graph,verify_research_facts,export_research_report,verify_research_facts | 6 | 54.6s |  |
| F1_lfr_demo_end_to_end | extract_literature_tables,prepare_spectral_measurements,fit_line_lfr | 3 | 78.1s |  |
| F2_likelihood_chain_specificity | list_cosmology_datasets,build_cosmology_likelihood,run_cosmology_likelihood_chain | 3 | 25.1s |  |
| F3_abstention_specificity | search_literature,classify_literature_relevance | 2 | 8.4s |  |
| F4_dataset_substitution_disclosure | list_cosmology_datasets,build_cosmology_likelihood,run_cosmology_likelihood_chain | 3 | 31.1s |  |