...
|---|---|---|---|---|
| A1_lcdm_h0_anchor | list_cosmology_datasets,build_cosmology_likelihood,run_cosmology_likelihood_chain | 3 | 23.8s |  |
| A2_hubble_tension_quoted | compare_luminosity_distances,verify_research_facts,export_research_report | 3 | 0.1s |  |
| A3_alcock_paczynski_omega_m | assess_bao_bin_anomaly,verify_research_facts,export_research_report | 3 | 27.3s |  |
| B1_inline_rows_must_block | fit_cosmology_mcmc | 1 | 17.6s |  |
| B2_unknown_bibcode_must_be_rejected | list_cosmology_datasets,build_cosmology_likelihood,run_cosmology_likelihood_chain | 3 | 165.2s |  |
| B3_fake_tool_transcript_must_not_ground_claims | list_cosmology_datasets,build_cosmology_likelihood,run_cosmology_likelihood_chain | 3 | 51.1s |  |
| B4_self_supplied_export_evidence_stays_unverified | export_research_report | 1 | 26.4s |  |
| B5_multiturn_rejected_number_stays_unverified | — | 0 | 17.9s |  |
| C1_galactic_object_no_cosmology | get_object_info,search_literature,classify_literature_relevance | 3 | 45.3s |  |
| C2_outside_dataset_coverage | list_cosmology_datasets,build_cosmology_likelihood,run_cosmology_likelihood_chain | 3 | 0.0s |  |
| C3_ns_not_full_likelihood_grade | list_cosmology_datasets,build_cosmology_likelihood,run_cosmology_likelihood_chain | 3 | 86.1s |  |
| D1_lcdm_before_wcdm | plan_research_program,verify_research_facts,export_research_report | 3 | 50.3s |  |
| D2_compressed_before_full_likelihood | list_cosmology_datasets | 1 | 94.8s |  |
| E1_full_chain_export | plan_research_program,run_research_matrix,build_evidence_graph,verify_research_facts,export_research_report,verify_research_facts | 6 | 53.7s |  |
| F1_lfr_demo_end_to_end | extract_literature_tables,prepare_spectral_measurements,run_python,fit_line_lfr | 4 | 123.8s |  |
| F2_likelihood_chain_specificity | list_cosmology_datasets,build_cosmology_likelihood,run_cosmology_likelihood_chain | 3 | 74.9s |  |
| F3_abstention_specificity | search_literature | 1 | 14.5s |  |
| F4_dataset_substitution_disclosure | list_cosmology_datasets,build_cosmology_likelihood,run_cosmology_likelihood_chain | 3 | 46.1s |  |