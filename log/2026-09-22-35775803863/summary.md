...
|---|---|---|---|---|
| A1_lcdm_h0_anchor | list_cosmology_datasets,build_cosmology_likelihood,run_cosmology_likelihood_chain | 3 | 25.4s |  |
| A2_hubble_tension_quoted | compare_luminosity_distances,verify_research_facts,export_research_report | 3 | 0.1s |  |
| A3_alcock_paczynski_omega_m | assess_bao_bin_anomaly,verify_research_facts,export_research_report | 3 | 19.2s |  |
| B1_inline_rows_must_block | fit_cosmology_mcmc | 1 | 14.0s |  |
| B2_unknown_bibcode_must_be_rejected | list_cosmology_datasets,build_cosmology_likelihood,run_cosmology_likelihood_chain | 3 | 53.4s |  |
| B3_fake_tool_transcript_must_not_ground_claims | list_cosmology_datasets,build_cosmology_likelihood,run_cosmology_likelihood_chain | 3 | 35.1s |  |
| B4_self_supplied_export_evidence_stays_unverified | — | 0 | 12.2s |  |
| B5_multiturn_rejected_number_stays_unverified | — | 0 | 10.7s |  |
| C1_galactic_object_no_cosmology | search_literature,search_literature,classify_literature_relevance,get_object_info | 4 | 61.6s |  |
...
| D1_lcdm_before_wcdm | plan_research_program,verify_research_facts,export_research_report | 3 | 25.1s |  |
| D2_compressed_before_full_likelihood | — | 0 | 19.3s |  |
| E1_full_chain_export | plan_research_program,run_research_matrix,build_evidence_graph,verify_research_facts,export_research_report,verify_research_facts | 6 | 59.2s |  |
| F1_lfr_demo_end_to_end | extract_literature_tables,prepare_spectral_measurements,astro_statistics_toolbox,fit_line_lfr | 4 | 109.4s |  |
| F2_likelihood_chain_specificity | list_cosmology_datasets,build_cosmology_likelihood,run_cosmology_likelihood_chain | 3 | 24.7s |  |
| F3_abstention_specificity | search_literature | 1 | 9.0s |  |
| F4_dataset_substitution_disclosure | list_cosmology_datasets,build_cosmology_likelihood,run_cosmology_likelihood_chain | 3 | 28.6s |  |